...
void    ImFontAtlas::ClearInputData()
{
    ...
    // When clearing this we lose access to the font title and other information used to build the font.
...
ImFont* ImFontAtlas::AddFontFromFileTTF(const char* filename, float size_pixels, const ImFontConfig* font_cfg_template, const ImWchar* glyph_ranges)
{
    ...
    {
        // Store a short copy of filename into into the font title for convenience
        const char* p;
