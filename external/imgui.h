...
namespace ImGui
{
    ...
    // In this header file we use the "label"/"title" terminology to denote a string that will be displayed and used as an ID,
    ...
    // Widgets: Value() Helpers. Output single value in "title: value" format (tip: freely declare more in your code to handle your types. you can add functions to the ImGui namespace)
...
enum ImGuiStyleVar_
{
    // Enum title ......................// Member in ImGuiStyle structure (see ImGuiStyle for descriptions)
...
struct ImDrawList
{
    ...
    const char*             _OwnerName;         // Pointer to owner window's title for debugging
